...
return [
    ...
    */
    ...
    'custom_permissions' => (static function (): array {
        $models = [
            App\Models\Cabeceraccd::class => 'Cabecera CCD',
            App\Models\Registrosccd::class => 'Registros CCD',
            App\Models\Cabecerafuid::class => 'Cabecera FUID',
            App\Models\Registrosfuid::class => 'Registros FUID',
            App\Models\Matriztvd::class => 'Matriz TVD',
            App\Models\Periodo::class => 'Periodo',
            App\Models\Seccion::class => 'Sección',
            App\Models\Subseccion::class => 'Subsección',
            App\Models\Series::class => 'Serie',
            App\Models\Subseries::class => 'Subserie',
            App\Models\Consulta::class => 'Consulta',
            App\Models\ConsultaFuid::class => 'Consulta FUID',
        ];
        ...
        foreach ($models as $label) {
            foreach ($actions as $action) {
                $permissions["{$action}:{$label}"] = ucfirst($action) . " {$label}";
            }
        }
