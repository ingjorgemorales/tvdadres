        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title">Importar Cuadros de Clasificación Documental</h3>
                </div>
                <div class="card-body">
                    ...
                    <form id="frImport" action="{{ route('importccd.importcsv') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
